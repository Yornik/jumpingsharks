# jumpingsharks — technical overview

> Moved from the repository root. The root `README.md` is the short operator-facing version; this file keeps the full narrative and diagrams.
